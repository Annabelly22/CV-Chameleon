        ...
        {showPastePanel && (
          <div className="si" style={{background:"#161B22",border:"1px solid #6A3DAA",borderRadius:8,padding:20,marginBottom:20}}>
            ...
            <div style={{marginBottom:12}}>
              <div style={{fontSize:9,color:"#7D8590",letterSpacing:".1em",marginBottom:5}}>JOB DESCRIPTION — paste full text for best results</div>
              <textarea className="jd-input" rows={12} placeholder="Paste the full job description here. The more complete, the more surgical the tailoring — responsibilities, qualifications, tools, standards…" value={pasteJD} onChange={e=>setPasteJD(e.target.value)} />
            </div>
